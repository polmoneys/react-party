...
var Party = function (props) {
    var _a = React.useState(null), pathValues = _a[0], setPathValues = _a[1];
    ...
    var draw = React.useCallback(function () {
        ...
        matchRefsToPoints(refs, boundary, x, y)
            ...
            if (variant === 'line') {
                return line()(__spreadArray([], points));
            }
            else {
                return line().curve(curveCardinal)(__spreadArray([], points));
            }
        })
            .then(function (path) {
            var p = path;
    ...
    return (React.createElement("svg", { className: "party-svg", style: {
            transform: transforms ? transforms : undefined,
        } }, pathValues && (React.createElement("path", { vectorEffect: "non-scaling-stroke", fill: "none", stroke: fill, strokeWidth: weigth, strokeLinecap: round ? 'round' : 'square', strokeLinejoin: round ? 'round' : 'miter', d: pathValues }))));
};
